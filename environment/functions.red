...
acos: func [
	"Returns the trigonometric arccosine of x (in radians)"
	x [float!]
][
	#system [
		stack/arguments: stack/arguments - 1
...
asin: func [
	"Returns the trigonometric arcsine of x (in radians)"
	x [float!]
][
	#system [
		stack/arguments: stack/arguments - 1
...
atan: func [
	"Returns the trigonometric arctangent of x (in radians)"
	x [float!]
][
	#system [
		stack/arguments: stack/arguments - 1
